...
public class MainInterface {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out
				.println("Enter 4 to show maximal correctness and test date in Go/No Go experiment.");
		System.out
				.println("Enter 5 to delete record with too long duration in BalanceBeam experiment.");
		...
		while (flag) {
			...
			case 3:
				System.out
						.println("You choose to show average weights for each animals.");
				db.avgWeights();
				flag = false;
				break;
			...
			case 4:
				System.out
						.println("You choose to show maximal correctness and test date in experiment Go/No Go.");
			...
			case 5:
				System.out
						.println("You choose to delete record with too long duration in BalanceBeam experiment.");
