...
public class MainInterface {
	...
	public static void main(String[] args) throws Exception{
		...
		while(flag){
			...
			switch (choice){
				case 1: System.out.println("You choose to insert new data.");
				db.insertDataBase(keyboard);
				flag = false;
				break;
				
				case 2: System.out.println("You choose to update data.");
				db.updateDataBase(keyboard);
				flag = false;
				break;
				
				case 3: System.out.println("You choose to show average weights for each animals.");
				db.avgWeights();
				flag = false;
				break;
				
				case 4: System.out.println("You choose to show maximal correctness and test date in experiment Go/No Go.");
				db.maxCorrectness(keyboard);
				flag = false;
				break;
				
				case 5: System.out.println("You choose to delete record with too long duration in BalanceBeam experiment.");
				db.deleteLongDuration(keyboard);
				flag = false;
				break;
				
				case 0: System.out.println("You choose to exit.");
				flag = false;
				break;
